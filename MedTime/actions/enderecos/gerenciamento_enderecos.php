            ...
            <tbody>
                <?php foreach ($lista_localizacao as $local) { ?>
                    <tr>
                        ...
                        <td><?= $local['ddd']; ?></td>
                        <td><?= $local['tipo']; ?></td>
                        <td><button type="submit" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modalEdicao" data-id="<?= $local['id']; ?>" data-cep="<?= $local['cep']; ?>" data-logradouro="<?= $local['logradouro']; ?>" data-complemento="<?= $local['complemento']; ?>" data-bairro="<?= $local['bairro']; ?>" data-localidade="<?= $local['localidade']; ?>" data-uf="<?= $local['uf']; ?>" data-ddd="<?= $local['ddd']; ?>" data-tipo="<?= $local['tipo']; ?>">
