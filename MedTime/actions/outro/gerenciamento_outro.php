      ...
      <tbody>
        <?php foreach ($lista_cargos as $cargo) { ?>
          <tr>
            ...
            <td>
              <a href="#" class="btn btn-danger btn-sm" onclick="excluir(<?= $cargo['id']; ?>)">
        ...
        <?php foreach ($lista_especialidades as $especialidade) { ?>
          <tr>
            ...
            <td>
              ...
              data-especificacao="<?= $especialidade['especificacao']; ?>"
              data-id_cargo="<?= $especialidade['id_cargo']; ?>"
              data-nome_cargo="<?= $especialidade['nome']; ?>">
                <i class="bi bi-pencil-square"></i> Editar</button>
            </td>
            <td>
              <a href="#" class="btn btn-danger btn-sm" onclick="excluir(<?= $especialidade['id']; ?>)">
                <i class="bi bi-file-earmark-x"></i> Excluir
              </a>
            </td>
          </tr>
        ...
        <?php foreach ($lista_exames as $exame) { ?>
          <tr>
            ...
            <td>
              ...
              data-id_resp="<?= $exame['id_responsavel']; ?>"
              data-funcionario_resp="<?= $exame['funcionario_resp']; ?>">
                <i class="bi bi-pencil-square"></i> Editar</button>
            </td>
            <td>
              <a href="#" class="btn btn-danger btn-sm" onclick="excluir(<?= $exame['id']; ?>)">
                <i class="bi bi-file-earmark-x"></i> Excluir
              </a>
            </td>
          </tr>
