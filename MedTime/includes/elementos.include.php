                        ...
                        <div class="collapse navbar-collapse justify-content-center text-center" id="navbarNav">
                            <ul class="navbar-nav">
                                <li class="nav-item px-3">
                                    <a class="nav-link <?php if($paginaAtiva == "1"){echo "active";} ?>" aria-current="page" href="paginainicial.php">Página
                                        Inicial</a>
                                </li>
                                <li class="nav-item px-3">
                                    <a class="nav-link <?php if($paginaAtiva == "2"){echo "active";} ?>" href="consultas.php">Consultas</a>
                                </li>

                                <li class="nav-item px-3">
                                    <a class="nav-link <?php if($paginaAtiva == "3"){echo "active";} ?>" href="agendamentos.php">Agendamentos</a>
                                </li>
                                <li class="nav-item px-3">
                                    <a class="nav-link <?php if($paginaAtiva == "4"){echo "active";} ?>" href="contate_nos.php">Contate-nós</a>
                                </li>
                            </ul>
                        </div>
